...
const CrossedBox = () => {
  return (
    <div className="pt-40 flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-black w-full gap-4 mx-auto px-8">
      <div className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-6xl w-full mx-auto p-4 relative h-[40rem]">
